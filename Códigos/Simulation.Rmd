...
#Coincident sampling event and coalescent event: results may be unpredictable.  What it means?
...
```
Plotting five random individuals simulations for 200 taxa:
```{r}
set.seed(9)
#111  13 104 108 221
...
p
```
Plotting an individual random simulation:
