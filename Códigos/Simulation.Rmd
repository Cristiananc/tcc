...
all_estimates <- rbind(summaries_gumbel_20taxa, summaries_gumbel_20taxa,
...
peffpop <- ggplot(data = for_plot, aes(x = time, y = mean, col = piror, group = replicate)) +
    ...
    guides(col = FALSE) +
    theme_bw() +
    geom_line(yintercept = 10, linetype = "dashed", size = .8) +
    NULL
```
